...
namespace PublicTransportGallery.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new Data.ApplicationDbContext.ApplicationUser { UserName = model.Username, Email = model.Email };
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new Data.ApplicationDbContext.ApplicationUser { UserName = model.Email, Email = model.Email };
